...
For more informtaion on sechduled queries, see  [Manage Scheduled Queries](https://github.com/polylogyx/platform-docs/tree/pooja-develop/Queries_and_packs#manage-scheduled-queries). 
