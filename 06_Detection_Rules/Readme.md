...
PolyLogyx provides a set of predefined rules that can serve as a starting point to enable you to define rules specific to your needs. You can define rules using the web interface. 
